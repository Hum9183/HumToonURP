...
namespace Hum.HumToon.Editor.HeaderScopes.MatCap
{
    public class MatCapValidator : IHeaderScopeValidator
    {
        ...
        private void SetKeywords(Material material)
        {
            ...
            bool existsMatCapMask = material.GetTexture(IDMatCapMask) is not null;
            CoreUtils.SetKeyword(material, MatCapKeywordNames._HUM_USE_MAT_CAP_MASK, useMatCap && existsMatCapMap && existsMatCapMask);
        }
    }
}
